...
# Set the file path
csvpath = Path('Rutgers-FinTech/01-Lesson-Plans/02-Python/3/Activities/09-Ins_CSV_Reader/Resources/accounting.csv')
...
output_path = Path('Rutgers-FinTech/01-Lesson-Plans/02-Python/3/Activities/09-Ins_CSV_Reader/Solved/output.csv')
